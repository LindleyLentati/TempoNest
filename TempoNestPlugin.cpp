...
*/
	...
	//				printf("%i %i %g \n", i, j, bsum);
			...
			if(interpolateProfile == 1){
				...
				PreComputeShapelets(StoredShapelets, InterpolatedMeanProfile, InterpolatedJitterProfile, finalInterpTime, numtointerpolate, MeanBeta);
